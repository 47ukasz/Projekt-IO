...
namespace projekt_io.Migrations
{
    ...
    [Migration("20260111005941_ChangeChatModels")]
    partial class ChangeChatModels
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("projekt_io.Entities.Chat", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("projekt_io.Entities.Chat", b =>
                {
                    b.HasOne("projekt_io.Entities.ApplicationUser", "Creator")
                        .WithMany()
                    ...
                    b.HasOne("projekt_io.Entities.ApplicationUser", "Owner")
                        .WithMany()
                        .HasForeignKey("OwnerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("projekt_io.Entities.Sighting", "Sighting")
                        .WithMany()
            ...
            modelBuilder.Entity("projekt_io.Entities.Message", b =>
                {
                    b.HasOne("projekt_io.Entities.Chat", "Chat")
                        .WithMany("Messages")
                        .HasForeignKey("ChatId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("projekt_io.Entities.ApplicationUser", "Sender")
                        .WithMany()
